    ...
    >
      ...
      >
        ...
        <div className="relative z-10">
          ...
          <p className="text-muted-foreground font-body mb-4 leading-relaxed font-times">
            {project.description}
          </p>
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {project.tags.map((tag) => (
              <span
                key={tag}
                className="px-3 py-1 rounded-full text-xs font-body bg-muted text-muted-foreground font-times"
              >
                {tag}
              </span>
            ))}
